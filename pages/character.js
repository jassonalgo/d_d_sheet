...
class Player extends React.Component {
  ...
  <header>
    <section class="charname">
      <label for="charname">Character Name</label><input name="charname" placeholder="Thoradin Fireforge" defaultValue = {currentPlayer.name}/>
    </section>
    <section class="misc">
      <ul>
        <li>
          <label for="classlevel">Class & Level</label><input name="classlevel" placeholder="Paladin 2"  defaultValue = {currentCharacter.info.class}/>
        </li>
        <li>
          <label for="background">Background</label><input name="background" placeholder="Acolyte" />
        </li>
        <li>
          <label for="playername">Player Name</label><input name="playername" placeholder="Player McPlayerface"  defaultValue = {currentPlayer.userName}/>
        </li>
        <li>
          <label for="race">Race</label><input name="race" placeholder="Half-elf"  defaultValue = {currentCharacter.info.race}/>
        </li>
        <li>
          <label for="alignment">Alignment</label><input name="alignment" placeholder="Lawful Good"  defaultValue = {currentCharacter.info.Alineamiento}/>
        </li>
        <li>
      ...
      <section class="attributes">
        <div class="scores">
          <ul>
            <li>
              <div class="score">
                <label for="Strengthscore">Strength</label><input name="Strengthscore" placeholder="10" defaultValue = {currentCharacter.characteristics.strength} />
              </div>
              <div class="modifier">
            ...
            <li>
              <div class="score">
                <label for="Dexterityscore">Dexterity</label><input name="Dexterityscore" placeholder="10" defaultValue = {currentCharacter.characteristics.dexterity}/>
              </div>
              <div class="modifier">
            ...
            <li>
              <div class="score">
                <label for="Constitutionscore">Constitution</label><input name="Constitutionscore" placeholder="10" defaultValue = {currentCharacter.characteristics.constitution}/>
              </div>
              <div class="modifier">
            ...
            <li>
              <div class="score">
                <label for="Wisdomscore">Wisdom</label><input name="Wisdomscore" placeholder="10" defaultValue = {currentCharacter.characteristics.wisdom} />
              </div>
              <div class="modifier">
            ...
            <li>
              <div class="score">
                <label for="Intelligencescore">Intelligence</label><input name="Intelligencescore" placeholder="10" defaultValue = {currentCharacter.characteristics.intelligence} />
              </div>
              <div class="modifier">
            ...
            <li>
              <div class="score">
                <label for="Charismascore">Charisma</label><input name="Charismascore" placeholder="10" defaultValue = {currentCharacter.characteristics.charisma} />
              </div>
              <div class="modifier">
    ...
    <section>
      <section class="combat">
        ...
        <div class="hp">
          <div class="regular">
            <div class="max">
              <label for="maxhp">Hit Point Maximum</label><input name="maxhp" placeholder="10" type="text" defaultValue = {currentCharacter.hitPoint}/>
            </div>
            <div class="current">
